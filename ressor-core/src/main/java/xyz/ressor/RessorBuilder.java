...
public class RessorBuilder<ServiceType, DataType> {
    ...
    public ServiceType build() {
        ...
        ProxyContext.ProxyContextBuilder<ServiceType, DataType> ctx = ProxyContext.<ServiceType, DataType>builder(type)
                .source(source)
                .resource(resource)
        ...
        RessorService<ServiceType> proxy = (RessorService<ServiceType>) proxyBuilder.buildProxy(ctx.build());
        if (isAsync) {
