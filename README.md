...
```
  implementation 'xyz.ressor:ressor-core:1.1.0'
  implementation 'xyz.ressor:ressor-git-source:1.1.0'
  implementation 'xyz.ressor:ressor-http-source:1.1.0'
  implementation 'xyz.ressor:ressor-s3-source:1.1.0'
```

### Java 8

```
  implementation 'xyz.ressor:ressor-core-jdk8:1.1.0'
  implementation 'xyz.ressor:ressor-git-source-jdk8:1.1.0'
  implementation 'xyz.ressor:ressor-http-source-jdk8:1.1.0'
  implementation 'xyz.ressor:ressor-s3-source-jdk8:1.1.0'
```
