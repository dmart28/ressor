...
public class SingleSourceMultipleServices {
    ...
    public static void main(String[] args) {
        ...
        HttpSource httpSource = Http.builder()
        ...
        CharSequence serviceOne = createService(ressor, httpSource, "serviceOne.txt");
        CharSequence serviceTwo = createService(ressor, httpSource, "serviceTwo.txt");
